                        ...
                        <View style={styles.formWrap}>
                            ...
                            <View style={styles.reviewsTop}>
                                <View style={styles.reviewsTopLeft}>
                                    <View style={[styles.reviewScore,{backgroundColor: '#0B5C19',}]}><TextBold style={{color:'#FFF', fontSize: 24}}>{formatNumber(totalScore/criteriaJsx.length)}</TextBold></View>
