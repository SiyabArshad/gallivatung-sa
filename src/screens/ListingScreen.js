...
{/**snady part */}
                            <View style={{display:excerpt?"flex":"none",width:"100%",padding:10,borderRadius:5,backgroundColor:"lightgrey",marginBottom:10}}>
...
{/**end sandy part */}             
                        ...
                        <View style={{width:"100%",padding:10,marginBottom:10,borderRadius:5,display:viewCount?"flex":"none",
...
{/**end feature */}
                            ...
                            <View style={{marginTop: 10,}}>
                                    {address != '' && <View style={[styles.contactItem,{display:address?"flex":"none"}]}>
                                        <TextRegular style={styles.contactItemLabel}>{translate('slisting','contact_address')}</TextRegular>
                                        <TextRegular >{address}</TextRegular>
                                    </View>}

                                    {phone != '' && <View style={[styles.contactItem,{display:phone?"flex":"none"}]}>
                                    ...
                                    {email != '' && <View style={[styles.contactItem,{display:email?"flex":"none"}]}>
                                    ...
                                    {website != '' && <View style={[styles.contactItem,{display:website?"flex":"none"}]}>
                    ...
                    { loading == false && <View style={[styles.screenFooter,{borderTopColor: apColors.separator,}]}>
                        ...
                        <TouchableOpacity onPress={()=>  NavigationService.navigate( 'Comments' )} style={styles.screenFooterLeft}>
                            <Text style={[styles.price,{fontWeight:"bold"}]}>Add Review</Text>
