            ...
            <View style={[styles.inner, this.props.style]}>
                <View style={styles.reviewsTop}>
                    <View style={styles.reviewsTopLeft}>
                        { null != rating && rating.rating > 0 && <View style={[styles.reviewScore,{backgroundColor: "#0B5C19",}]}><TextBold style={{color:'#FFF', fontSize: 24}}>{rating.rating}</TextBold></View> }
            ...
            <View style={styles.criteriaInner}>
                ...
                <View style={styles.criteriaDetails}>
                    <View style={styles.rFieldBg}>
                        <View style={[styles.rFieldValue,{backgroundColor: "#0B5C19",width: props.data.percent+'%'}]}></View>
                    </View>
